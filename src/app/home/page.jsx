                            ...
                            <li className="mr-4 mb-2">
                                <button
                                    className={`${isButtonAllDisabled
                                        ...
                                        : 'hover:text-white hover:bg-[#002859]'
                ...
                <div className="lg:ml-auto mt-4 lg:mt-0 flex flex-wrap items-center text-[8px] lg:text-xs mb-2">
                    <div className="mr-4">
                        <div className="pt-1 sm:pt-2 relative mb-2">
                            <input className="border h-9 sm:h-10 border-[#5CFFFF] border-opacity-50 bg-[#5CFFFF] placeholder-[#5CFFFF] bg-opacity-20 text-neutral-400 px-4 rounded-md focus:outline-none w-[280px] sm:w-[550px] md:w-[400px] lg:w-[220px] xl:w-[300px] 2xl:w-[500px] text-xs xl:text-sm " name="search" placeholder="Buscar juego" />
                            <button type="submit" className="absolute right-0 top-0 mt-3.5 sm:mt-5 mr-4">
                                <svg className="h-4 :w-4 fill-[#5CFFFF] hover:fill-opacity-50" xmlns="http://www.w3.org/2000/svg" version="1.1" id="Capa_1" viewBox="0 0 56.966 56.966">
