                ...
                <div className="sm:ml-auto flex flex-wrap items-center text-[8px] lg:text-xs mb-2">
                    <div className="mr-4">
                        <div className="pt-1 sm:pt-2 relative mb-2">
                            <input className="text-sm border h-6 lg:h-10 border-[#005EC1] border-opacity-50 bg-neutral-900 bg-opacity-80 text-neutral-400 px-4 rounded-md focus:outline-none w-80" name="search" placeholder="Buscar" />
                            <button type="submit" className="absolute right-0 top-0 mt-3 sm:mt-5 mr-4">
                                <svg className="h-2 w-2 lg:h-4 lg:w-4 fill-[#005EC1] hover:fill-opacity-50" xmlns="http://www.w3.org/2000/svg" version="1.1" id="Capa_1" viewBox="0 0 56.966 56.966">
                    ...
                    <div className="mb-4 flex flex-col">
                        ...
                        <select className="text-sm text-neutral-400 bg-neutral-900 px-2 py-1 border border-neutral-500 rounded-md h-10">
