    ...
    return (
        <div className=''>
            ...
            <div className="flex flex-wrap items-center sm:py-2 px-10 w-full sm:mt-0 mt-4">
                {!showWishList &&
                    <div className="block text-xs xl:text-sm text-neutral-400">
                ...
                <div className="lg:ml-auto mt-4 lg:mt-0 flex flex-wrap items-center text-[8px] lg:text-xs mb-2">
                    <div className="mr-4">
                        <div className="pt-1 sm:pt-2 relative mb-2">
                            <input className="border h-9 sm:h-10 border-[#9170DC] border-opacity-50 bg-[#9170DC] placeholder-[#9170DC] bg-opacity-10 text-neutral-400 px-4 rounded-md focus:outline-none w-[280px] sm:w-[550px] md:w-[400px] lg:w-[220px] xl:w-[300px] 2xl:w-[500px] text-xs xl:text-sm " name="search" placeholder="Buscar juego" />
                            <button type="submit" className="absolute right-0 top-0 mt-3.5 sm:mt-5 mr-4">
                                <svg className="h-4 :w-4 fill-[#9170DC] hover:fill-opacity-50" xmlns="http://www.w3.org/2000/svg" version="1.1" id="Capa_1" viewBox="0 0 56.966 56.966">
                    ...
                    <div className="mb-5 flex flex-col">
                        ...
                        <select className="text-neutral-400 bg-neutral-900 px-2 py-1 border border-neutral-500 rounded-md h-9 sm:h-10 w-[280px] sm:w-[275px] md:w-[260px] lg:w-[125px] xl:w-[200px] text-xs xl:text-sm">
