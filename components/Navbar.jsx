...
const navigation = [
    ...
    { name: 'Recomendado', actualPage: 'home/recommended', nextPage: '/home' },
]
                                        ...
                                        {navigation.map((item) => (
                                            <a
                                                ...
                                                className={classNames(
                                                    actualPage === item.actualPage ? "text-neutral-600 cursor-not-allowed" : "text-white hover:text-blue-600"
                                                )}
